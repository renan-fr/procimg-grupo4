...
def isolamento_cor(img_bgr, cor="vermelho", tolerancia_h=10, s_min=60, v_min=50):
    """Isola uma cor usando HSV. Retorna imagem isolada e a máscara (0-255).
    Ajuste mínimo: tratar vermelho com wrap de H e não exibir janelas/plots.
    """
    import numpy as np
    import cv2 as cv
